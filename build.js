...
Promise.all(icons.map(icon => {
  ...
  let component = `
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="{strokeWidth}" stroke-linecap="round" stroke-linejoin="round" class="unicons ${icon.name} {customClass}">
      <path
      d="${svgPath}"
      />
    </svg>
